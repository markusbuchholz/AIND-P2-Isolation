...
def custom_score_2(game, player):
    ...
    move_score = float(len(game.get_legal_moves(player)) * 4 - len(game.get_legal_moves(game.get_opponent(player))) * 2)
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def min_value(self, game, depth):
        ...
        for m in legal_moves: 
            ...
            bestvalue_new = min(bestvalue, v)
        return bestvalue_new
